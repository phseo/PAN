...
class BatchNormLayer(lasagne.layers.Layer):
    ...
    def __init__(self, incoming, axes=None, epsilon=0.01, alpha=0.5,
            nonlinearity=None, rescale=True, beta=lasagne.init.Constant(0), gamma=lasagne.init.Constant(1), 
            mean=lasagne.init.Constant(0), std=lasagne.init.Constant(1), fixed=False, **kwargs):
        """
